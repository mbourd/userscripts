...
(async () => {
  ...
  const _strSelector002 = ()=>myDeciph("515c431b5441434250574559544c504746515e185c5b535a57544718565a5b41545c5b504715515c430f5b415d18565d5c59511d041c15515c430f5b415d18565d5c59511d061c15515c430f5b415d18565d5c59511d071c"); // div.atvwebplayersdk-infobar-container div:nth-child(1) div:nth-child(3) div:nth-child(2)
...
const _null = ()=>window[_JSON()][_parse()](myDeciph("5b405959")); // null
  ...
  function executeIntervalCheck() {
      ...
      if (video()[_readyState()] <= _number3) {muteVideos();hideVideos();return;}
              ...
              if (skipNext[_innerText()][_match](regExpSkip()) && !next) {
                  isWaitingNext = _false();
        isResumingEpisode = _false();
                  playPause()[_click()]();
        ...
        await sleep(_number1);
                  ...
                  while (video()[_readyState()] <= _number3) {await sleep(_number23);}
                  await sleep(_number123 + getRandomArbitrary(_number0, _number30));
                  playPause()[_click()]();
              ...
              if ((!isWaitingNext && !isResumingEpisode || skipNext[_innerText()][_match](regExpNextEpisode())) && !next) {
                  isResumingEpisode = _false();
                  isWaitingNext = _false();
        muteVideos(_false());hideVideos(string012());
                  window[_clearInterval()](interval);
